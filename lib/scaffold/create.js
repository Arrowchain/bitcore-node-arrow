...
var BASE_PACKAGE = {
  description: 'A full Arrow node build with Bitcore',
  repository: 'https://github.com/Arrowchain/bitcore-node-arrow',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-arrow': 'Arrowchain/bitcore-lib-arrow',
    'bitcore-node-arrow': 'Arrowchain/bitcore-node-arrow'
  }
};
